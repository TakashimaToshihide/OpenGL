========================================================================
    Win32 アプリケーション: nyanpas プロジェクトの概要
========================================================================

この nyanpas アプリケーションは、AppWizard により作成されました。
...
nyanpas.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル nyanpas.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル nyanpas.rc 
    にインクルードされます。
